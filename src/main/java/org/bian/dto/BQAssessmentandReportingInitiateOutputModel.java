...
/**
 * BQAssessmentandReportingInitiateOutputModel
 */
public class BQAssessmentandReportingInitiateOutputModel   {
  private String assessmentandReportingInstanceReference = null;

  private String assessmentandReportingInitiateActionReference = null;

  private Object assessmentandReportingInitiateActionRecord = null;

  private String assessmentandReportingInstanceStatus = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Assessment and Reporting instance 
   * @return assessmentandReportingInstanceReference
  **/

  public String getAssessmentandReportingInstanceReference() {
    return assessmentandReportingInstanceReference;
  }

  public void setAssessmentandReportingInstanceReference(String assessmentandReportingInstanceReference) {
    this.assessmentandReportingInstanceReference = assessmentandReportingInstanceReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to an Initiate service call 
   * @return assessmentandReportingInitiateActionReference
  **/

  public String getAssessmentandReportingInitiateActionReference() {
    return assessmentandReportingInitiateActionReference;
  }

  public void setAssessmentandReportingInitiateActionReference(String assessmentandReportingInitiateActionReference) {
    this.assessmentandReportingInitiateActionReference = assessmentandReportingInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Assessment and Reporting instance (e.g. initialised, pending, active) 
  ...
  **/
  ...
  public void setAssessmentandReportingInstanceStatus(String assessmentandReportingInstanceStatus) {
    this.assessmentandReportingInstanceStatus = assessmentandReportingInstanceStatus;
  }
